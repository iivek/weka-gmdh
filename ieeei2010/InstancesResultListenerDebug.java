 ...
 */
public class InstancesResultListenerDebug
   ...
   * Sets temporary file.
   */
  public InstancesResultListenerDebug() {

    File resultsFile;
/*    try {
      resultsFile = File.createTempFile("../Selected Datasets, parameter testing/weka_experiment", ".arff");
  ...
  */
    resultsFile = new File("../CMS_experiment.arff");
  ...
  /**
   * Used when trying to deserialize listener and producer
   */
    public void imitatePreProcess(ResultProducer rp) throws Exception {
